function find(content) {
    ...
    $.get("http://tikhon.zapto.org:5000/find?word=" + content,
...
function sendHtml(mode, url) {
    ...
    if (mode != "chrome") {
        xmlHttp.open("GET", "http://tikhon.zapto.org:5000/parse?url=" + my_url, false)
        ...
        xmlHttp.open("GET", "http://tikhon.zapto.org:5000/parse_chrome?url=" + url, false)
        xmlHttp.send();
        $('#chrome_analyze__process').toggle()
